...
module.exports = async (req, res) => {
  ...
  const url = `https://graph.facebook.com/${META_API_VERSION}/${acc}/insights?fields=${fields}&time_range=${timeRange}&time_increment=1&limit=500&access_token=${encodeURIComponent(process.env.META_ACCESS_TOKEN)}`;
